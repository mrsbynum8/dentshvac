    ...
    <div className="pt-32 pb-20 px-6 min-h-screen bg-slate-50">
      <div className="max-w-4xl mx-auto">
        <motion.div 
          ...
          className="text-center mb-12"
        >
          <h1 className="text-4xl md:text-5xl font-bold text-text mb-4">Request Residential Service</h1>
          <p className="text-xl text-text/70">Fast, reliable heating and cooling service for your home. Schedule your visit below.</p>
        </motion.div>
        ...
        <motion.div 
          ...
          animate={{ opacity: 1, scale: 1 }}
          transition={{ delay: 0.2 }}
          className="bg-white rounded-[2rem] p-4 md:p-8 shadow-2xl shadow-slate-200/50 border border-slate-100 min-h-[1300px] relative overflow-hidden"
        >
          <div className="absolute inset-0 flex items-center justify-center -z-10">
            <div className="text-center">
              <Loader2 className="w-10 h-10 animate-spin text-primary mx-auto mb-4" />
          ...
          <iframe
            src="https://brand.dentsheatingandcooling.com/widget/form/s4VkICseV4kNJfxqrM6a"
            style={{ width: '100%', height: '100%', border: 'none', borderRadius: '8px' }}
            id="inline-s4VkICseV4kNJfxqrM6a" 
            data-layout="{'id':'INLINE'}"
            data-trigger-type="alwaysShow"
            data-trigger-value=""
            data-activation-type="alwaysActivated"
            ...
            data-deactivation-type="neverDeactivate"
            data-deactivation-value=""
            data-form-name="Dents HC — Residential Service Request"
            data-height="1263"
            data-layout-iframe-id="inline-s4VkICseV4kNJfxqrM6a"
            data-form-id="s4VkICseV4kNJfxqrM6a"
            title="Dents HC — Residential Service Request"
          ></iframe>
        </motion.div>
      </div>
    </div>
    ...
    <div className="pt-32 pb-20 px-6 min-h-screen bg-slate-50">
      <div className="max-w-4xl mx-auto">
        <motion.div 
          ...
          className="text-center mb-12"
        >
          <h1 className="text-4xl md:text-5xl font-bold text-text mb-4">Completed Work Form</h1>
          <p className="text-xl text-text/70">Please complete the details for the finished project below.</p>
        </motion.div>
        ...
        <motion.div 
          ...
          animate={{ opacity: 1, scale: 1 }}
          transition={{ delay: 0.2 }}
          className="bg-white rounded-[2rem] p-4 md:p-8 shadow-2xl shadow-slate-200/50 border border-slate-100 min-h-[1100px] relative overflow-hidden"
        >
          <div className="absolute inset-0 flex items-center justify-center -z-10">
            <div className="text-center">
              <Loader2 className="w-10 h-10 animate-spin text-primary mx-auto mb-4" />
          ...
          <iframe
            src="https://brand.dentsheatingandcooling.com/widget/form/ffStSxOi3VT4ut7sVjEo"
            style={{ width: '100%', height: '100%', border: 'none', borderRadius: '8px' }}
            id="inline-ffStSxOi3VT4ut7sVjEo" 
            data-layout="{'id':'INLINE'}"
            data-trigger-type="alwaysShow"
            data-trigger-value=""
            data-activation-type="alwaysActivated"
            ...
            data-deactivation-type="neverDeactivate"
            data-deactivation-value=""
            data-form-name="Dents HC — Completed Work Form"
            data-height="1057"
            data-layout-iframe-id="inline-ffStSxOi3VT4ut7sVjEo"
            data-form-id="ffStSxOi3VT4ut7sVjEo"
            title="Dents HC — Completed Work Form"
          ></iframe>
        </motion.div>
      </div>
    </div>
    ...
    <div className="min-h-screen selection:bg-primary selection:text-white">
      ...
      <main>
        <Routes>
          ...
          <Route path="/request-service" element={<ResidentialRequestPage />} />
          <Route path="/gerald" element={<GeraldPage />} />
        </Routes>
      </main>
